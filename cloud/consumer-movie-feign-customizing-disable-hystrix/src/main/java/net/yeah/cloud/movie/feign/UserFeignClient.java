...
import net.yeah.cloud.movie.hystrix.UserHystrixFallBack;
import net.yeah.cloud.movie.pojo.User;
import org.springframework.cloud.netflix.feign.FeignClient;

// 自定义feign
@FeignClient(name = "provider-user", configuration = UserConfiguration.class, fallback = UserHystrixFallBack.class)
