...
import net.yeah.cloud.movie.hystrix.UserHystrixFallBack2;
...
// 自定义feign
@FeignClient(name = "name", url = "http://localhost:8092/", configuration = UserConfiguration2.class, fallback = UserHystrixFallBack2.class)
